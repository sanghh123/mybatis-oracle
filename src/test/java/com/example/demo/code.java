...
//        String projectPath = System.getProperty("user.dir");
        ...
        config.setActiveRecord(true)
                ...
                .setOutputDir("F:/1gongshi/projectall/sxtree/company1/src/main/java")
                /**
                 *      // 项目路径
...
//                .setInclude("zqgk_study_admin", "zqgk_study_agents")
                //.setInclude("tibms_sx_lanelist","tb_List_EnPass","tb_List_ExPass","tb_List_OtherTrans")
                .setInclude("BIN_LIST_ETC_NEW__ERROR","BIN_LIST_NEW_ERROR","BIN_LIST_OUT_ETC_NEW__ERROR","BIN_LIST_OUT_NEW_ERROR")
                // 去除表前缀
                .setTablePrefix("APP_BD_");

        //4. 包名策略配置
        PackageConfig pkConfig = new PackageConfig();
        pkConfig.setParent("com.example.config")
                // mapper层
                .setMapper("mapper")
                // service 层
                .setService("service")
